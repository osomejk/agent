...
const QRScanner = ({ onScan, onError }) => {
  ...
  return (
    <div className="relative w-full h-64 overflow-hidden">
      ...
      <div id="client-qr-reader" className="w-full h-full"></div>
    </div>
  )
}
...
export default function ClientScanQRPage() {
  ...
  const handleScan = (decodedText: string, scanner: any) => {
    try {
      ...
      // For clients, redirect to the client dashboard product page
